...
Write-Host ""
Write-Host "📝 handover-generator 설치 중..." -ForegroundColor Cyan
Write-Host ""
...
Write-Host '  "인수인계서 작성해줘"' -ForegroundColor Cyan
Write-Host ""
